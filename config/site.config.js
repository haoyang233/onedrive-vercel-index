...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'haoyang@haoyang0213.onmicrosoft.com',
  ...
  links: [
    {
      name: 'download',
      link: 'https://www.123pan.com/s/DrkuVv-3MUgH',
    },
  ],
